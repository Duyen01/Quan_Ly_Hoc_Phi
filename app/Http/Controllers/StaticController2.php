    ...
    public function statusStudent(Request $request, $id){
        ...
        //Thống kê học phí đã đóng 
            ...
            $bill = Bill::select('bill.*','admin.name as nameAdmin')
                ...
                ->paginate(5);
            return view('admin.student.show', compact('so_lan_theo_nam','so_lan_theo_thang','so_lan_theo_ky','student','status','tong_tien','dataPoints','count','so_thang_phai_dong','ngay_bat_dau','id','year','bill'));
